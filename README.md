...
Certifique-se de que o arquivo .html e seu respectivo arquivo .js (ex: questao01.html e questao01.js) estejam salvos na mesma pasta.

Abra o arquivo .html desejado diretamente no seu navegador web (Google Chrome, Firefox, etc.).
...
O script coleta todos os valores dos campos de entrada.

Utiliza um template literal para formatar uma frase contendo todas as informações.

Exibe essa frase em um parágrafo (<p id="resultado">) abaixo do formulário.

Estiliza o parágrafo de resultado com a cor verde e um tamanho de fonte maior (24px).
